...
SVGjsAnim.prototype.setupRefining = function () {
  ...
  var heading = this.draw
    .heading("REFINING", this.wistiaObjs.refining)
  ...
  bulletsGroup.add(
    this.draw
      .bullets(["INDUCTION FURNACE SMELTS\nGOLD INTO DORÉ BARS"], 50)
      .move(275, 180)
  );

  bulletsGroup.add(
    this.draw
      .bullets(["OVEN DRIES ELECTROWINNING\nCONCENTRATE FOR SMELTING"], 150)
      .move(535, 50)
  );
  ...
  step.content(
    this.draw
      .image("images/refinery/smelted.svg", 6, 67)
      .move(this.smeltedX, this.smeltedY)
      .attr({ id: "smelted" })
  );

  var goldPan = this.draw
    .image("images/gold_in_pan.svg", 82, 22)
    .move(829, 559);
  var rect = this.draw
    .rect(82, 22)
    .move(829, 580)
  ...
  step.content(
    this.draw
      .image("images/refinery/gold_bar.svg", 95, 56)
  ...
  step.content(
    this.draw
      .image("images/refinery/glow.svg", 168, 168)
