...
SVG.GrindingSlurry = SVG.invent({
  ...
  construct: {
    grindingSlurry: function (id) {
      return this.put(new SVG.GrindingSlurry()).build(id);
    },
  },
});
...
SVG.extend(SVG.GrindingSlurry, {
  buildSAGToCyclone: function () {
    ...
    var raw =
      ...
      id +
      '" fill="none" stroke="#939598" stroke-width="4" stroke-miterlimit="10" d="M2595 263.895v116.348h-60.5"/></svg>';
...
SVG.extend(SVG.GrindingSlurry, {
  buildConcentratorTable: function () {
    ...
    var raw =
      '<svg xmlns="http://www.w3.org/2000/svg" width="3676" height="1255.939" viewBox="0 0 3676 1255.939"><path id="' +
      id +
      '" fill="none" stroke="#BA8E2D" stroke-width="4" stroke-miterlimit="10" d="M3676 303.895H2331.973v-16.927"/></svg>';
...
SVG.extend(SVG.GrindingSlurry, {
  buildCycloneToThickener: function () {
    ...
    var raw =
      '<svg xmlns="http://www.w3.org/2000/svg" width="3676" height="1255.939" viewBox="0 0 3676 1255.939"><path id="' +
      id +
      '" fill="none" stroke="#939598" stroke-width="4" stroke-miterlimit="10" d="M3676 188.62H2595v29.348"/></svg>';
...
SVG.extend(SVG.GrindingSlurry, {
  buildMill10: function () {
    ...
    var raw =
      '<svg xmlns="http://www.w3.org/2000/svg" width="3676" height="1255.939" viewBox="0 0 3676 1255.939"><path id="' +
      id +
      '" fill="none" stroke="#939598" stroke-width="2" stroke-miterlimit="10" d="M2297.402 361.535v-89.788h16.88"/></svg>';
...
SVG.extend(SVG.GrindingSlurry, {
  buildMill90: function () {
    ...
    var raw =
      '<svg xmlns="http://www.w3.org/2000/svg" width="3676" height="1255.939" viewBox="0 0 3676 1255.939"><path id="' +
      id +
      '" fill="none" stroke="#939598" stroke-width="4" stroke-miterlimit="10" d="M2279.402 361.535V248.747h296.265"/></svg>';
...
SVG.extend(SVG.GrindingSlurry, {
  buildCycloneKnelson: function () {
    ...
    var raw =
      '<svg xmlns="http://www.w3.org/2000/svg" width="3676" height="1255.939" viewBox="0 0 3676 1255.939"><path id="' +
      id +
      '" fill="none" stroke="#939598" stroke-width="4" stroke-miterlimit="10" d="M2331.973 263.895v-15.148h246.36"/></svg>';
