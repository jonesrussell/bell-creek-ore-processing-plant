...
SVG.Truck = SVG.invent({
    ...
    extend: {
       build: function(x, y) {
            ...
            this.truckBucket = this.doc().image('images/truck/truck_dump.svg', 117, 51)
                .move(39, -10);
...
SVG.extend(SVG.Truck, {
    go: function() {
        ...
        var self = this;
        this.travel(self)
            .then(function(){ return self.up(); })
            .then(function(){ return self.dump(); })
            .then(function(){ return self.down(); })
            .then(function(){ return self.leave(); })
            .done(function(){
                self.go();
            });
        return this;
